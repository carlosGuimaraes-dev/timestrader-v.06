...
# NB-LINT-IGNORE: !pip uninstall -y dopamine-rl gym > /dev/null 2>&1

# Install stable, non-yanked versions of SB3 and Gymnasium known to be compatible.
# NB-LINT-IGNORE: !pip -q install gymnasium==0.28.1 stable-baselines3==2.2.1 tensorboard matplotlib pandas
...
# NB-LINT-IGNORE: %load_ext tensorboard
print(f"Using LOG_DIR={LOG_DIR}")
# NB-LINT-IGNORE: %tensorboard --logdir "$LOG_DIR" --port 6006
